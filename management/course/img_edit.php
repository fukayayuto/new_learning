        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <h1 class="h2">アイコン編集</h1>
                    <a href="/management/course/?id=<?php echo $place;?>"><button type="button" class="btn btn-primary">一覧に戻る</button></a>
                </div>

                <div class="container">

<form class="needs-validation" action="img_update.php" method="post" enctype="multipart/form-data">
    ...
    <hr class="mb-4">
    <button class="btn btn-primary btn-lg btn-block" type="submit">アイコンを変更する</button>
</form>
