        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="col-md-8 order-md-1">
                    <form class="needs-validation" action="store.php" method="post" id="form" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label for="lastName">所要時間</label>
                                <input type="number" class="form-control" id="progress" name="progress" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea name="detail" id="detail" rows="20" class="form-control" required></textarea>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label for="lastName"> イメージアイコン</label>
