        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="col-md-8 order-md-1">
                    <form class="needs-validation" action="/management/account/store.php" method="post" id="form">
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="sales_office" name="sales_office" value="" required>
                            </div>
                        </div>
                        <br>
    ...
    <script>
        $(function() {
            $("#form").submit(function() {
                if (window.confirm('この内容で顧客登録しますか?')) {
                    return true;
                } else {
                    return false;
                }
