        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
              ...
              <div class="card-header">
                ...
                <img src="../common/img/management/<?php echo $val['image']; ?>" alt="予約画像" style="width: 300px;height: 200px;">
              </div>
              <div class="card-body">
                 <a href="/management/reserve/<?php echo $place; ?>">
                  <button type="button" class="btn btn-lg btn-block btn-primary">予約状況確認</button>
                </a>
                <a href="/management/course/?id=<?php echo $val['id']; ?>">
                <button type="button" class="btn btn-lg btn-block btn-secondary-primary">詳細</button>
                </a>
              </div>
            </div> -->
