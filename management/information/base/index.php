    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <h1 class="h2">インフォメーション一覧(初任者用)</h1>
          <a href="/management/information/base/form.php"><button type="button" class="btn btn-primary">新規インフォメーション作成</button></a>
            ...
            <tbody>
              <?php foreach ($data as $k => $val) : ?>
                <tr>
                  ...
                  <td><a href="/management/information/base/detail?id=<?php echo $val['id']; ?>"><button type="button" class="btn btn-primary">変更</button></a></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
