        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="col-md-8 order-md-1">
                    <form class="needs-validation" action="status_update.php" method="post" id="form">
                        ...
                        <hr class="mb-4">
                        <button class="btn btn-primary btn-lg btn-block" type="submit">ステータスを変更する</button>
                    </form>
                </div>
        </div>
        </main>
