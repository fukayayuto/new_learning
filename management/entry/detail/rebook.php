        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="col-md-8 order-md-1">
                    <form class="needs-validation" action="change.php" method="post" id="form">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="name_1" id="name_1" class="form-control" value="<?php echo $name_1; ?>" required>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                        ...
                        <hr class="mb-4">
                        <button class="btn btn-primary btn-lg btn-block" type="submit" id="submi">変更する</button>
                    </form>
                </div>
        </div>
        </main>
    ...
    <script>
        $(function() {
            $("#form").submit(function() {
                ...
                const name_3 = $("#name_3").val();
                const name_4 = $("#name_4").val();
                const name_5 = $("#name_5").val();
