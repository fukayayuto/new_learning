        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <h1 class="h2">メールテンプレート作成</h1>
                </div>

                <div class="col-md-8 order-md-1">
                    <form class="needs-validation" action="confirm.php" method="post" id="form">
                        <div class="row">
                            <div class="col-md-12">
                                <label for="lastName">用途</label>
                                <input type="text" class="form-control" id="method" name="method" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label for="lastName">本文テキスト</label>
                                <textarea name="text" id="text" rows="22" class="form-control" required></textarea>
                            </div>
                        </div>
                        <br>

                        <hr class="mb-4">
                        <button class="btn btn-primary btn-lg btn-block" type="submit">確認画面へ</button>
                    </form>
                </div>
