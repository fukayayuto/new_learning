        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <h1 class="h2">メールテンプレート変更確認画面</h1>
                    <a href="/management/mail/template/detail/?id=<?php echo $data['id']; ?>"><button type="button" class="btn btn-primary">メールテンプレート詳細へ</button></a>
                </div>
                ...
                <div class="container">
                    <form method="POST" action="update.php">
                        ...
                        <div class="form-group">
                            <label>件名</label><br>
                            <label><?php echo $_POST['method']; ?></label>
                        </div>
