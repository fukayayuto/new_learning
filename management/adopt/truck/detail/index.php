    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <h1 class="h2">実績編集画面</h1>
          <a href="/management/adopt/truck"><button type="button" class="btn btn-primary">実績一覧へ</button></a>
        ...
        <div class="container">
          ...
          <form method="POST" action="update.php" id="form">
            ...
            <div class="form-group">
              <label>会社名</label>
              <input type="text" class="form-control" id="company_name" name="company_name" value="<?php echo $data[0]['company_name']; ?>">
            </div>

            <div class="form-group">
              <label>表示フラグ</label>
              <select class="form-control" id="display_flg" name="display_flg">
                <option value="0" <?php if ($data[0]['display_flg'] == 0) {
                                    echo 'selected';
                                  } ?>>非表示</option>
                <option value="1" <?php if ($data[0]['display_flg'] == 1) {
                                    echo 'selected';
                                  } ?>>表示</option>
              </select>
            </div>
