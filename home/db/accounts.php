...
function updateAccount($id,$email,$company_name,$sales_office,$phone,$memo,$name_1,$name_2,$name_3,$name_4,$name_5){
    ...
    $stmt = $pdo->prepare("UPDATE accounts SET  email = :email, company_name = :company_name, sales_office = :sales_office, phone = :phone , memo = :memo , updated_at = :updated_at, name_1 = :name_1, name_2 = :name_2, name_3 = :name_3, name_4 = :name_4,name_5 = :name_5  WHERE  id = :id;");
        $stmt->bindValue(':id', $id, PDO::PARAM_INT);
        $stmt->bindValue(':email', $email, PDO::PARAM_STR);
