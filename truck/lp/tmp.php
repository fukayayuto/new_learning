		...
		<main>
			...
			<div id="info">
				...
				<div class="tableBox">
					<table>
						<tr>
							<th>所要時間</th>
							<td>受講開始日より最長7日間、任意の時間に12時間分をeラーニングで受講していただきます。</td>
						</tr>
					</table>
				</div>
				<div class="tableBox">
						...
						<tr>
							...
							<td>
								<ul>
									...
									<li>健康管理の重要性</li>
									<li>安全性の向上を図る為の装置を備える事業用自動車の適切な運転方法</li>
								</ul>
								<p>※国土交通省の定める必要学習時間15時間のうちの12時間に相当します。<br>
									※実際の車両を用いて行う指導項目は含まれていません。<br>
									◆講座は全部で15講座あります。（12項目＋ドラレコを使用した危険予測講座2＋実力テスト1）</p>
							</td>
						</tr>
					</table>
				</div>
					...
					<table>
						<tr>
							...
							<td>一般：1名<span>11,000円</span>（税込）<br>
								...
								【振込口座】三井住友銀行　渋谷支店　普通9492637　株式会社キャブステーション</td>
						</tr>
					</table>
				</div>
			...
			<div class="reserveBox">
				<div class="lBox">
					...
					<ul class="price">
						<li>
							<h5>非会員</h5>
							<p>1名<span>11,000円</span>(税込)</p>
						</li>
						<li>
							<h5>グッドラーニング！会員</h5>
							<p>1名<span>7,700円</span>(税込)</p>
						</li>
					</ul>
					<p>※受付締切：2日前まで<br>
						※定員がございますので、お早めにご予約ください。</p>
				</div>
				<div class="rBox">
					<p class="btn">
			...
			<div id="flow">
				...
				<ol>
					...
					<li>受講完了後、受講の資料をデータにてお渡しいたします。
						<span class="cap">※国土交通省の定めにより当該教材を3年間、お手元で保管してください。</span>
					</li>
				</ol>
			</div>
			<div id="reason">
			...
			<div id="faq">
				...
				<dl>
					...
					<dd>法令改正があった場合のみ更新されますので、年度更新ではありません。</dd>
				</dl>
			</div>
		</main>
		<footer>
