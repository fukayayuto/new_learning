                      ...
                      <?php if ($val['display_flg'] == 1) : ?>
                        <tr>
                          ...
                          <?php if ($val['left_seat'] > 0) : ?>
                            ...
                            <?php else : ?>
                              <td><a href="/truck/reservation/mie/?id=<?php echo $val['id'] ?>&recom=<?php echo $introducer_id; ?>"><button class="member">残り<span><?php echo $val['left_seat']; ?></span>席</button></a></td>
                            <?php endif; ?>
                          <?php else : ?>
