...
<head>
  ...
  <meta name="title" content="料金について｜トラックドライバー教育のクラウド型eラーニング【グッドラーニング!】" />
  <meta name="description" content="グッドラーニング！の料金プランは通常プラン・2年割引プラン・2年割ライトプランの3つのプランをご用意しております。" />
  <meta name="keywords" content="乗務員,教育,研修,Eラーニング,指導,国交省,トラック,運送業,グッドラーニング" />
  <meta property="og:title" content="料金について｜トラックドライバー教育のクラウド型eラーニング【グッドラーニング!】" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="http://localhost:8888/truck/price/" />
  ...
  <meta property="og:description" content="グッドラーニング！の料金プランは通常プラン・2年割引プラン・2年割ライトプランの3つのプランをご用意しております。" />
  <link rel="canonical" href="http://localhost:8888/truck/price/" />
...
<body>
  ...
  <div id="wrapper">
    ...
    <header>
      <div id="header">
        <p id="headLogo">
          <a href="/truck/"><img src="../common/img/shared/head_logo.svg" alt="グッドラーニング" width="262" height="50" loading="lazy" /></a>
        </p>
        <p id="headTxt">
    ...
    <main>
        ...
        <div id="breadCrumbs">
          <ol itemscope="" itemtype="https://schema.org/BreadcrumbList">
            <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem">
              <a href="/truck/" itemprop="item"><span itemprop="name">HOME</span></a>
      ...
      <ul id="price">
        <li>
          ...
          <p class="price">
            月額<span>13,200</span>円～<span class="noInclude">(別途システム導入費)</span>
          </p>
          <p class="info">
            一般安全講習教材パック<br />
            自社オリジナル教材作成機能は含みません
        ...
        <li>
          ...
          <p class="price">
            月額<span>16,500</span>円<span class="noInclude">(別途システム導入費)</span>
          </p>
          <p class="info">
        ...
        <li>
          ...
          <p class="price">
            月額<span>11,000</span>円<span class="noInclude">(別途システム導入費)</span>
          </p>
          <p class="info">
      ...
      <div id="optionPlan">
        <div class="inner">
          ...
          <div id="optionPrice">
            ...
            <ol>
              <li>
                <img src="../common/img/price/ico_calendar.png" alt="カレンダー" width="155" height="155" loading="lazy" />
                <h3>受講予約</h3>
                <p>
                  <a href="#calendar">下記受講開始日の席数ボタン</a>より予約してください。予約にはメールアドレスが必要です。
                </p>
              </li>
              <li>
                <img src="../common/img/price/iico_pay.png" alt="支払い" width="156" height="156" loading="lazy" />
                <h3>受講料支払</h3>
                <p>
                  予約が承認されると受講料のお支払いに関するご案内メールが届きます。<span>受講料は事前払いです。</span>
                </p>
              </li>
              <li>
                <img src="../common/img/price/ico_training.png" alt="受講" width="155" height="152" loading="lazy" />
                <h3>受講</h3>
                <p>
              ...
              <li>
                <img src="../common/img/price/ico_comp.png" alt="修了" width="135" height="148" loading="lazy" />
                <h3>修了</h3>
                <p>
          ...
          <div id="application">
            ...
            <div id="calendar">
              <table>
                ...
                <tbody id="display" style="display: none;font-weight: 600;">
                  <?php foreach ($data as $val) : ?>
      ...
      <div id="contactBox">
        <div id="contactIn">
          ...
          <a href="/truck/contact/" class="btn">お問い合わせ・受講体験はこちら</a>
        </div>
      </div>
    </main>
    <!-- //main -->
  ...
  <script>
    $(function() {
      ...
      if (res == 2) {
        swal('現在別のお客様が予約申し込み中です。\nお手数おかけしますが、少しお時間あけていただいてから、申し込みお願い致します。');
      }
    });
  </script>
