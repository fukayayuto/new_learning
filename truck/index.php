...
<html lang="ja">
  <head>
    ...
    <meta property="og:url" content="http://localhost:8888/truck/" />
    <meta
      property="og:image"
    ...
    <meta
      ...
      content="グッドラーニング！は、国交省の「一般的な指導および監督の指針」に対応した、運転者の指導教育に特化したeラーニングシステムです。時間と場所を選ばずに、すべての乗務員に対して効率よく指導教育を実施することができます。"
    />
    <link rel="canonical" href="http://localhost:8888/truck/" />
        ...
        <div id="global">
          ...
          <nav>
            <ul>
              ...
              <li><a href="/truck/contact/" target="_blank">お問い合わせ</a></li>
            </ul>
          </nav>
        </div>
      </header>
          ...
          <div class="pointBox">
            ...
            <div>
              ...
              <ul>
                <li>
                  <a
                    href="http://localhost:8888/truck/common/img/sample_pdf.pdf"
                    target="_blank"
                    class="icoPdf"
                    >出力サンプルはこちらから</a
                  >
