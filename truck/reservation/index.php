...
<body>
  ...
  <script>
    $(function() {
      ...
      $('select').change(function() {
        ...
        if (val >= 2) {
          $('#name_text').append('<span style=" margin-top: 5em;">必須</span>');
        ...
        if (val >= 3) {
          $('#name_text').append('<span style=" margin-top: 10em;">必須</span>');
        ...
        if (val >= 4) {
          $('#name_text').append('<span style=" margin-top: 15em;">必須</span>');
        ...
        if (val >= 5) {
          $('#name_text').append('<span style=" margin-top: 20em;">必須</span>');
  ...
  <script>
      $(function() {
        ...
        if (res == 1) {
          swal('システムエラーが発生しました。お手数ですがもう一度入力お願い致します。');
        } 
