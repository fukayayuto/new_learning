...
if(empty($_SESSION["flg"])){
  ...
  $mailTemplateData = getMailTemplate(2);
...
<html lang="ja">
  <head>
    ...
    <meta
      name="title"
      content="三重県トラック協会予約依頼｜トラックドライバー教育のクラウド型eラーニング【グッドラーニング!】"
    />
    <meta
      name="description"
      content="グッドラーニング！についての三重県トラック協会予約依頼はこちらから受け付けております。お気軽にお問合せください。"
    />
    <meta
      name="keywords"
    ...
    <meta
      property="og:url"
      content="http://localhost:8888/truck/reserve/"
    />
    <meta
      property="og:image"
    ...
    <meta
      ...
      content="三重県トラック協会予約依頼はこちらから受け付けております。お気軽にお問合せください。"
    />
    <link
      rel="canonical"
      href="http://localhost:8888/truck/reserve/"
    />
      ...
      <main>
        ...
        <div class="inner">
          <div id="contact" class="thanks">
            <h2>三重県トラック協会予約依頼を承りました。</h2>
            <p class="thanksTxt">
            この度は「三重県トラック協会のご予約依頼」をいただき、誠にありがとうございます。<br />
              <br />
