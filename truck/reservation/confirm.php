...
//     header('Location: http://localhost:8888/truck/reservation/?id=' . $reservation_id . '&res=1');
//   }
// }
// if($count == 3){
//   if(empty($_POST['name_2'])|| empty($_POST['name3'])){
//     header('Location: http://localhost:8888/truck/reservation/?id=' . $reservation_id . '&res=1');
//   }
// }
// if($count == 4){
//   if(empty($_POST['name_2'])|| empty($_POST['name_3']) || empty($_POST['name_4'])){
//     header('Location: http://localhost:8888/truck/reservation/?id=' . $reservation_id . '&res=1');
//   }
// }
// if($count == 5){
//   if(empty($_POST['name_2'])|| empty($_POST['name_3']) || empty($_POST['name_4']) || empty($_POST['name_5'])){
//     header('Location: http://localhost:8888/truck/reservation/?id=' . $reservation_id . '&res=1');
//   }
// }
